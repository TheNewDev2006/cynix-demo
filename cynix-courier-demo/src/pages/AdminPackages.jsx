...
export function AdminPackages() {
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div>
         <h1 className="text-3xl font-bold text-white tracking-tight">All Packages</h1>
         <p className="text-white/60 mt-1">Manage and track every shipment in the system.</p>
      </div>
         ...
         <div className="p-6 border-b border-white/10 flex justify-between items-center bg-white/5">
            <div className="flex items-center gap-4">
                <div className="relative w-64">
                   ...
                   <input type="text" placeholder="Search tracking or customer..." value={search} onChange={e => setSearch(e.target.value)} className="search-pill" />
                </div>
                <button className="flex items-center gap-2 text-white/60 hover:text-white transition-colors text-sm px-4 py-2 rounded-full border border-white/10 bg-white/5">
